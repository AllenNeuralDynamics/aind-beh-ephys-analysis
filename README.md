...
- `dorsal_edges`: Dorsal edge of LC, labeled by hand and convered to CCF locations. 
...
- `all 'sorted' data`: Kilosort data.
- `all 'sorted_curated' data`: Kilosort data after manual curation. 
