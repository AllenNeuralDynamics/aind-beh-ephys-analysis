...
def session_dirs(session_id, model_name = None, data_dir = '/root/capsule/data/LC-NE_scratch_data_06-14-2025', scratch_dir = '/root/capsule/data/LC-NE_scratch_data_06-14-2025'):
    # parse session_id
