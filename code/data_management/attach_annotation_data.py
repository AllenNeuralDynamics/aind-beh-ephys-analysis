...
cols_selected = ['animal_id', 'ibl_converted', 'stitched']
data_df = data_df[cols_selected]
data_df = data_df.drop_duplicates()

# %%
col_to_attach = ['ibl_converted', 'stitched']
...
for curr_col in col_to_attach:
    ...
    curr_mount = [str(session_curr) + '_' + curr_col for session_curr in animal_ids]
