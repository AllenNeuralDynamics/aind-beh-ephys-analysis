...
ani_names = ['672850', '669492', '669489', '754898', '754896', '754895', '749624', '749472', '701707', '699472', '699461', '699462']
# ani_names =['754898']
all_session_names = []
all_session_ids = []
all_old_ids = []
...
for ani_name in ani_names:
    ...
    response = docdb_api_client.retrieve_docdb_records(
        filter_query=filter)
    data_asset_ids = [curr_response['external_links']['Code Ocean'][0] for curr_response in response if not curr_response['name'].startswith('behavior') and 'nwb' in curr_response['name']]
    session_ids = ['behavior_' + curr_response['name'].split('_nwb')[0] for curr_response in response if not curr_response['name'].startswith('behavior') and 'nwb' in curr_response['name']]
...
save_dir = os.path.join(script_dir, 'hopkins_FP_session_assets.csv')
